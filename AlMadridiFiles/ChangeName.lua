...
if result.id_ then 
local abbs = DevAbs:get("AlMadridiTEAM:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevAbs:del("AlMadridiTEAM:Name"..result.id_) 
end
end
...
DevAbs:set("AlMadridiTEAM:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
