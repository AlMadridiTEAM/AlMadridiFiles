...
if Manager(msg) then
if DevAbs:get(AlMadridi.."Abs:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAbs:set(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAbs:set(AlMadridi.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(AlMadridi.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(AlMadridi.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(AlMadridi..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(AlMadridi.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(AlMadridi.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevAbs:del(AlMadridi.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbs:incrby(AlMadridi.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عذرا عزيزي ↫ ["..result.first_name_.."](https://t.me/"..(result.username_ or "Dev_Prox")..")\n⌁︙عليك وضع التوحيد ↫ `"..DevAbs:get(AlMadridi.."Abs:ProNames:Txt"..msg.chat_id_).."` بجانب اسمك\n⌁︙عدد المحاولات المتبقيه ↫ "..(tonumber(ProNamesTxt) - tonumber(UserNum)).."")
end
end
end
end,nil)
...
DevAbs:set(AlMadridi.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbs:del(AlMadridi.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
