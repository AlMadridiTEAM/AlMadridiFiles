...
if DevAbs:get(AlMadridi.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(AlMadridi.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(AlMadridi.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(AlMadridi.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(AlMadridi.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(AlMadridi.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
AlMadridiName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if AlMadridiName then 
AlMadridiNames = DevAbs:smembers(AlMadridi.."Abs:Mute:Names"..msg.chat_id_) or ""
if AlMadridiNames and AlMadridiNames[1] then 
for i=1,#AlMadridiNames do 
if AlMadridiName:match("(.*)("..AlMadridiNames[i]..")(.*)") then 
...
DevAbs:set(AlMadridi.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(AlMadridi.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
